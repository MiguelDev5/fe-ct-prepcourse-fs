...
function mesesDelAño(array) {
   ...
   let meses = array.filter(e => {
      if(e == "Enero" || e == "Marzo" || e == "Noviembre") return true;
   });
   return (meses.includes("Enero", "Marzo", "Noviembre")? meses: "No se encontraron los meses pedidos");
}
